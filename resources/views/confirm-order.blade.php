        ...
        <div class="w-full">
            <div class="max-w-4xl mx-auto my-16">
                ...
                <div class="mt-5 grid grid-cols-3 grid-rows-5 gap-5 w-full">
                    ...
                    <div class="bg-red-800 flex items-center justify-center text-white font-bold">حذف من العربة
                    </div>
            ...
            <form action="{{ route('shipping-details') }}" class="mt-20">
                <div class="mt-10 flex justify-end">
                    <button type="submit"
                        class="text-xl text-white font-bold bg-ornage-start px-16 py-2 rounded-2xl">تأكيد الطلب</button>
                </div>
            </form>
        </div>
    </div>
