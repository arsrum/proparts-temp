    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.orders.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('generic_article') ? 'is-invalid' : '' }}" type="number" name="generic_article" id="generic_article" value="{{ old('generic_article', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('article_no') ? 'is-invalid' : '' }}" type="number" name="article_no" id="article_no" value="{{ old('article_no', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('brand_no') ? 'is-invalid' : '' }}" type="number" name="brand_no" id="brand_no" value="{{ old('brand_no', '') }}" step="1">
