    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.contactuses.update", [$contactUs->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mobile') ? 'is-invalid' : '' }}" type="text" name="mobile" id="mobile" value="{{ old('mobile', $contactUs->mobile) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" type="text" name="title" id="title" value="{{ old('title', $contactUs->title) }}">
                @if($errors->has('title'))
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('done') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="done" id="done" value="1" {{ $contactUs->done || old('done', 0) === 1 ? 'checked' : '' }}>
